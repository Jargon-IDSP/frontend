...
export default function ProfilePage() {
    ...
    const badgeIcons = useMemo(() => {
        ...
        return userBadges
            ...
            .filter(
                (icon): icon is { id: string; name: string; url: string } =>
                        ...
                        <div className='profile-content'>
                            ...
                            <div className='profile-avatar-section'>
                                ...
                                <p className='profile-avatar-industry'>
                                    {data.industryId
                                        ? industryIdToName[data.industryId] ||
                                          "Not set"
                                        : "Not set"}
                                </p>
                            </div>
                            ...
                            <div className='profile-mini-cards'>
                                <div className='profile-mini-card'>
                                    ...
                                    <p className='profile-mini-card-label'>
                                        Vocabulary
                                    </p>
                                </div>
                                <div className='profile-mini-card'>
                            ...
                            <div className='profile-sections'>
                                <div className='profile-tabs'>
                                    ...
                                    <button
                                        ...
                                        onClick={() =>
                                            setActiveProfileTab("achievements")
                                        }>
                                        Achievements
                                    </button>
                                </div>
