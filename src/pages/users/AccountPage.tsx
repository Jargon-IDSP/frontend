...
export default function AccountPage() {
    ...
    const handleSave = async () => {
        ...
        if (
            profile?.industryId !== selectedIndustryId &&
            selectedIndustryId !== null
        ) {
            const industryName =
                industryIdToName[selectedIndustryId].toLowerCase();
            ...
            <div className='account-page'>
                        ...
                        <div
                            ...
                            <button
                                ...
                                <span
                                    ...
                                    {selectedIndustryId !== null
                                        ? industryIdToName[selectedIndustryId]
                                        : "Select your trade"}
                                </span>
                                <img
                                    src={downArrowBrown}
                        ...
                        <div
                            ...
                            <button
                                ...
                                <span
                                    ...
                                    {selectedLanguage !== null
                                        ? languageValueToLabel[selectedLanguage]
                ...
                <div className='account-delete-section'>
                    ...
                    <p className='account-delete-warning'>
                        Your account can be permanently removed from the
                        application at any time of use
                    </p>
                </div>
