...
export default function LoggedInHome() {
  ...
  useEffect(() => {
    if (!isProfileLoading && user && profile) {
      ...
      const hasSkippedThisSession =
        sessionStorage.getItem("onboardingSkippedThisSession") === "true";
        ...
        <div style={{ display: isPageLoading ? "none" : "block" }}>
          <>
            ...
            <div className="welcome-section">
              ...
              <DailyCheckIn />
              <StartLearningCard
                onReady={() => setIsStartLearningReady(true)}
              />
              <InstantHelpCard />
              <CommunityCard />
              <UploadFileCard />
              <img
                src={RockyFriends}
                alt="Rocky friends graphic"
                className="rocky-friends"
              />
            </div>
          </>
        </div>
