...
export default function OCRResultsModal({ document, onClose }: OCRModalProps) {
  ...
  // Fetch flashcards using TanStack Query
  const { data: flashcards = [], isLoading: loading } = useQuery({
    queryKey: ["documentFlashcards", document.id],
